...
public class StemmEs {
     ...
     * @return
     */
    private String removeHyphen(String word) {
    ...
    public String stemm(String word) {
        ...
        if (!suf.equals("")) {
            ...
            if (!pre_suff.equals("")) {
                ...
                word=removeHyphen(substr(word, 0,-strlen(suf)));
            } else {
        ...
        if (!(suf = endsinArr(r2_txt, array("anza", "anzas", "ico", "ica",
            ...
            word = substr(word, 0, -strlen(suf));
                ...
                "adoras", "adores", "aciones", "ante", "antes", "ancia",
                "ancias"))).equals("")) {
            word = substr(word, 0, -strlen(suf));
        ...
        if (word_after0.equals(word_after1)) {
            ...
            if (word_after2a.equals(word_after1)) {
                if (!(suf = endsinArr(rv_txt, array("en", "es", "éis", "emos","s"))).equals("")) {
                    word = substr(word, 0, -strlen(suf));
                    if (endsin(word, "gu")) {
                        word = substr(word, 0, -1);
                    }
                } else if (!(suf = endsinArr(rv_txt, array("arían", "arías",
                        "arán", "arás", "aríais", "aría", "aréis", "aríamos",
                        "aremos", "ará", "aré", "erían", "erías", "erán",
                        "erés", "eríais", "ería", "eréis", "eríamos", "eremos",
